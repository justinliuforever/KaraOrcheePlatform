    ...
    for p in pieces:
        ...
        if key not in state:
            ...
            meta = {
                ...
                "work": None, "book": {"id": BOOK_ID, "index": n},
            }
...
def main():
    ...
    run(args.split_dir, token, args.only, args.submit)
